...
public final class DAOStringConstant {

    /**
     * Строковые конмтанты для CarDAOdb
     */
    ...
    public static final String DAO_FIND_USER_CLOSE_CON_ERROR_MSG = "UserDAPdb : findUser : close connection error";
    public static final String DAO_ADD_USER_ERROR_MSG = "UserDAOdb : addUser : ERROR";
    public static final String DAO_ADD_USER_CLOSE_CON_ERROR_MSG = "UserDAOdb : addUser : close connection error";
    ...
    public static final String DAO_ADD_USER_STARTS_MSG = "UserDAO : create user : starts";
    public static final String DAO_ADD_USER_ENDS_MSG = "UserDAO : create user : ends";
